...
export default function Features() {
  return (
    <section className="relative py-16 overflow-hidden" id="features">
      ...
      {/* Gradient Orbs */}
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-brand-orange/5 rounded-full blur-3xl pointer-events-none z-0"></div>
      <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-blue-500/3 rounded-full blur-3xl pointer-events-none z-0"></div>
      <div className="absolute top-1/3 right-0 w-72 h-72 bg-cyan-400/2 rounded-full blur-3xl pointer-events-none z-0"></div>
      
      {/* Grid Pattern with Gradient */}
      <div className="absolute inset-0 bg-grid-pattern-light opacity-5 pointer-events-none z-0"></div>
      
      {/* Subtle Radial Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-navy-950/0 via-navy-950/30 to-navy-950/60 pointer-events-none z-0"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5">
          <div className="group bg-gradient-to-br from-navy-800 to-navy-900 border border-navy-700/50 rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1.5 hover:border-navy-600 hover:shadow-[0_0_30px_rgba(255,102,0,0.15)] relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-brand-orange/0 to-brand-orange/0 group-hover:from-brand-orange/5 group-hover:to-brand-orange/0 transition-all duration-300 pointer-events-none"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
          <div className="group bg-gradient-to-br from-brand-orange to-orange-500 rounded-2xl p-8 shadow-[0_0_40px_rgba(255,102,0,0.25)] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_0_60px_rgba(255,102,0,0.35)] overflow-hidden relative">
          ...
          <div className="group bg-gradient-to-br from-navy-800 to-navy-900 border border-navy-700/50 rounded-2xl p-8 flex flex-col justify-center transition-all duration-300 hover:-translate-y-1.5 hover:border-navy-600 hover:shadow-[0_0_30px_rgba(255,102,0,0.15)] relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-brand-orange/0 to-brand-orange/0 group-hover:from-brand-orange/5 group-hover:to-brand-orange/0 transition-all duration-300 pointer-events-none"></div>
            <div className="relative z-10">
        ...
        <div className="w-full group bg-gradient-to-br from-navy-800 to-navy-900 border border-navy-700/50 rounded-2xl p-6 flex flex-col md:flex-row items-center gap-6 transition-all duration-300 hover:-translate-y-1.5 hover:border-navy-600 hover:shadow-[0_0_30px_rgba(255,102,0,0.15)] relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-brand-orange/0 to-brand-orange/0 group-hover:from-brand-orange/5 group-hover:to-brand-orange/0 transition-all duration-300 pointer-events-none"></div>
          <div className="w-16 h-16 shrink-0 bg-gradient-to-br from-navy-900 to-navy-950 rounded-xl flex items-center justify-center border-2 border-navy-700 shadow-[0_0_20px_rgba(255,102,0,0.1)] relative z-10">
